...
namespace PI.Views
{
    ...
    public partial class Registration : Window
    {
        ...
        public PI.Models.Customer Customer { get; private set; }

        public Registration(PI.Models.Customer p)
        {
            InitializeComponent();
            Customer = p;
            this.DataContext = new PI.ViewModel.ApplicationViewModel();
        }
        ...
        {
            if (LoginBlock.Text != "" && EmailBlock.Text != "" && PasswordBox.Text != "")
            {
                if (PasswordBox.Text.Length > 6)
                {
                    ...
                    try
                    {
                        ...
                        string second_query = $"INSERT INTO Customer (Login,Password,Email) VALUES ('{LoginBlock.Text}', '{PasswordBox.Text}', '{EmailBlock.Text}');";
